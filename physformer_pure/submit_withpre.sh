...
LOG_DIR=/home/siming/physformer_pure/Inference_PURE_JSON_withpre   # Directory to save output results
...
nohup /root/anaconda3/bin/python run_physformer_pure_clip_withpre.py \
  --video_dir $VIDEO_DIR \
  --log $LOG_DIR \
  --clip_size $CLIP_SIZE \
