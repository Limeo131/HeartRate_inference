...
Original file is located at
    https://colab.research.google.com/drive/113WiWoK542iaBqq1rYi-Jgkbdu-08Wlk
"""
...
import sys
sys.path.append('/content/drive/MyDrive/facemedAI/phys/model/')
...
class ViT_ST_ST_Compact3_TDC_gra_sharp(nn.Module):
    ...
    def __init__(
        ...
        self.upsample = nn.Sequential(
            ...
            nn.Conv3d(dim, dim, kernel_size=(3, 1, 1), stride=1, padding=(1,0,0)),
            nn.BatchNorm3d(dim),
            nn.ELU(),
        )
        self.upsample2 = nn.Sequential(
            nn.Upsample(scale_factor=(2,1,1)),
            nn.Conv3d(dim, dim//2, kernel_size=(3, 1, 1), stride=1, padding=(1,0,0)),
            nn.BatchNorm3d(dim//2),
            nn.ELU(),
        )
