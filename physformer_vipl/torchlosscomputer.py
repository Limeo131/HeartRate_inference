# -*- coding: utf-8 -*-
"""TorchLossComputer.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1li_4BnXCO9n6qeGU5mdm_Et6Db9nD1u-
"""
...
class TorchLossComputer(object):
    ...
    def compute_complex_absolute_given_k(output, k, N):
        ...
        output = output.view(1, 1, -1).to(torch.float)
        k = k.view(1, -1, 1)
    ...
    def cross_entropy_power_spectrum_loss(inputs, target, Fs):
        ...
        whole_max_idx = whole_max_idx.to(torch.float)
    ...
    def cross_entropy_power_spectrum_focal_loss(inputs, target, Fs, gamma):
        ...
        return criterion(complex_absolute, target.view((1)).type(torch.long)), \
               torch.abs(target[0] - whole_max_idx)
    ...
    def cross_entropy_power_spectrum_forward_pred(inputs, Fs):
        ...
        complex_absolute = TorchLossComputer.complex_absolute(inputs, Fs, bpm_range)
        _, whole_max_idx = complex_absolute.view(-1).max(0)
        return whole_max_idx.to(torch.float)
