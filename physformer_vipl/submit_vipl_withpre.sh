...
LOG_DIR=/home/siming/physformer_vipl/Inference_Physformer_VIPL_withpre   # Output results directory
...
nohup /root/anaconda3/bin/python run_physformer_vipl_withpre.py \
  --video_dir $VIDEO_DIR \
  --csv_info $CSV_INFO \
  --log $LOG_DIR \
  --clip_size $CLIP_SIZE \
